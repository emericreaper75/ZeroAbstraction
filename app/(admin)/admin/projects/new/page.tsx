    ...
    <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#0a0a0a]">
      ...
      <header className="flex justify-between items-center h-20 px-12 border-b border-outline-variant sticky top-0 bg-[#0a0a0a]/90 backdrop-blur-md z-30">
        <div className="flex flex-col">
          ...
          <h1 className="text-4xl font-headline font-bold text-on-surface tracking-tight">New Project</h1>
        </div>
      ...
      {/* Form Area */}
      <form id="new-project-form" action={formAction} className="flex flex-1 overflow-y-auto custom-scrollbar">
        ...
        <section className="w-[65%] p-12 space-y-8">
          ...
          <div>
            ...
            <input
              name="title"
              required
              className="w-full bg-transparent border-b border-outline-variant py-4 text-3xl font-headline font-bold text-on-surface focus:border-[#c9c6c5] focus:outline-none transition-all placeholder:text-zinc-800"
          ...
          <div>
            ...
            <textarea
              name="content"
              className="w-full min-h-[400px] p-6 bg-[#0d0d0d] border border-outline-variant font-label text-sm leading-relaxed text-zinc-300 custom-scrollbar overflow-y-auto focus:outline-none focus:border-zinc-300 resize-none"
